...
function SummaryPage({ title, description, mode }: SummaryPageProps) {
...
export function OrderBookingSummaryPage() {
  return (
    <SummaryPage
      title="Order Summary"
...
export function BuyerGgWiseConfirmedQtyPage() {
  return (
    <SummaryPage
...
export function BwslDislProductionSummaryPage() {
  return (
    <SummaryPage
